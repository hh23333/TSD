...
"""
from .cosine_lr import CosineLRScheduler, CosineLRScheduler_withfz
...
def create_scheduler_fz(cfg, optimizer):
    num_epochs = cfg.SOLVER.MAX_EPOCHS - cfg.SOLVER.FREEZE_EPOCHS
    # type 1
    # lr_min = 0.01 * cfg.SOLVER.BASE_LR
    # warmup_lr_init = 0.001 * cfg.SOLVER.BASE_LR
    # type 2
    ...
    lr_scheduler = CosineLRScheduler_withfz(
            optimizer,
            t_initial=num_epochs,
            lr_min=lr_min,
            t_mul= 1.,
